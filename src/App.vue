    ...
    <div class="container">
      ...
      <template v-if="tickers.length">
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
          <div
            v-for="t in paginatedTicker"
            v-bind:key="t.name"
            @click="selectedTicet = t"
            :class="{
              'border-4': selectedTicet === t,
            }"
...
export default {
  ...
  created() {
    ...
    const tickerData = JSON.parse(localStorage.getItem("cryptoList"));
    if (tickerData) {
  ...
  methods: {
    ...
    handleDelete(tickerToRemove) {
      ...
      if (this.selectedTicet === tickerToRemove) {
        this.selectedTicet = null;
      }
    },
  },
